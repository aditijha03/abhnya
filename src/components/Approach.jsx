  ...
  return (
    <section id="about" className="py-24 bg-pastelWhite overflow-hidden">
      <div className="w-[95%] max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div className="relative grid grid-cols-2 gap-4 h-[400px] md:h-[600px] w-full">
          <img src="/images/gallery/Y&I 16.jpg.jpeg" alt="Approach Image 1" className="w-full h-full object-cover rounded-md shadow-lg" />
          <div className="grid grid-rows-2 gap-4 h-full">
            <img src="/images/gallery/Y&I 15.jpg.jpeg" alt="Approach Image 2" className="w-full h-full object-cover rounded-md shadow-lg" />
            <img src="/images/gallery/Y&I 12.jpg.jpeg" alt="Approach Image 3" className="w-full h-full object-cover rounded-md shadow-lg" />
          </div>
          <svg className="hidden md:block absolute left-[50%] top-[70%] -translate-x-1/2 -translate-y-1/2 w-64 h-64 text-calico opacity-80 pointer-events-none z-10 drop-shadow-sm" viewBox="0 0 200 200" fill="none" stroke="currentColor" strokeWidth="0.8">
