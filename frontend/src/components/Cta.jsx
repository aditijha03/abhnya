...
const Cta = ({ onOpenModal }) => {
  return (
    <section id="contact" className="bg-cover bg-center bg-fixed text-white py-24" style={{ backgroundImage: "linear-gradient(rgba(23,23,23,0.8), rgba(23,23,23,0.8)), url('/images/cta.PNG')" }}>
